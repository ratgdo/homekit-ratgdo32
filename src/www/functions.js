...
async function saveSettings() {
    ...
    */
    ...
    if (!(regexIPv4.test(localIP) && regexIPv4.test(subnetMask) && regexIPv4.test(gatewayIP) && (regexIPv4.test(nameserverIP) || regexIPv6.test(nameserverIP)) &&  regexIPv4.test(syslogIP))) {
